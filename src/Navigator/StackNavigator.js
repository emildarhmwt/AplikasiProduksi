...
function StackNavigator() {
    return (
        <Stack.Navigator initialRouteName="Home">
            <Stack.Screen name="Home" component={HomeScreen} options={{headerShown: true, title: 'Operation Report'}} />
            <Stack.Screen name="Data" component={DataScreen} options={{headerShown: true, title: 'Production Report'}}/>
            <Stack.Screen name="HM" component={HMScreen} options={{headerShown: true, title:'Hour Meter Report'}}/>
